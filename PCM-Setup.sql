...
CREATE TABLE Receives (
    PatientReceivesID INTEGER NOT NULL,
    TreatmentRecevivesID INTEGER NOT NULL,
    TreatmentStartDate NVARCHAR(11),
    TreatmentEndDate NVARCHAR(11),
    CONSTRAINT fk_patient_id FOREIGN KEY (PatientReceivesID) REFERENCES Patient(PatientID),
    CONSTRAINT fk_treatment_id FOREIGN KEY (TreatmentRecevivesID) REFERENCES Treatment(TreatmentID)
);
...
INSERT INTO Patient(PatientNotes, PatientFirstName, PatientMiddleName, PatientLastName, 
                    ...
                    PatientStartDate) 
            VALUES ('Patient is here for a tonsillectomy.', 'Jeremy', 'Andrew', 'Carter', '05/27/2015',
